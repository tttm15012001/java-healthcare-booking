...
import com.healthcare.booking.api.PatientResponse;
import com.healthcare.booking.dto.PatientInfo;
import com.healthcare.booking.model.PatientModel;
import com.healthcare.booking.repository.PatientRepository;
import com.healthcare.booking.api.PatientSpecification;
...
public class PatientService {
    ...
    public PatientInfo buildPatientInfoById(Long patientId) {
        PatientModel patient = this.patientRepository.findById(patientId).orElseThrow();
